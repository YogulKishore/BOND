...
Nudges: "And then?" / "Keep going." / "What happened after that?" / "What did she do?" / "Walk me through what came next."
...
NEVER follow a topic that isn't about their partner — not siblings, friends, yoga, games, work, parties
If they drift → redirect immediately: "Come back to [last thing about partner] — what happened after that?"
If they repeat → shift: "You've mentioned that — what happened after?"
If they offer insight or self-reflection → receive it, then ask what happened next — don't deepen it
